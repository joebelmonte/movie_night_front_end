...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getAllMovies = function getAllMovies(event) {
	  event.preventDefault();
	  api.getUsersMovies().then(ui.getAllMoviesSuccess).then(function () {
	    $('.all-movies-table').on('click', showOneMovie);
	  }).catch(ui.getAllMoviesFailure);
	};

	var onAddNewMovie = function onAddNewMovie(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.addNewMovie(data).then(ui.addNewMovieSuccess).then(function () {
	    api.getUsersMovies().then(ui.getAllMoviesSuccess).then(function () {
	      $('.all-movies-table').on('click', showOneMovie);
	    });
	...
	var showOneMovie = function showOneMovie(event) {
	  movieID = $(event.target).attr('data-id');
	  api.getSelectedMovie(movieID).then(ui.getSelectedMovieSuccess).then(function () {
	    $('.all-movies-table').on('click', showOneMovie);
	...
	var showUpdatedMovie = function showUpdatedMovie(movieID) {
	  api.getSelectedMovie(movieID).then(ui.getSelectedMovieSuccess).then(function () {
	    $('.all-movies-table').on('click', showOneMovie);
	    $('#delete-movie').on('submit', onDeleteMovie);
	    $('#update-movie').on('submit', onUpdateMovie);
	...
	var onUpdateMovie = function onUpdateMovie(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.updateMovie(data, movieID).then(ui.onUpdateMovieSuccess).then(function () {
	...
	var onDeleteMovie = function onDeleteMovie(event) {
	  event.preventDefault();
	  api.deleteMovie(movieID).then(ui.deleteMovieSuccess).then(function () {
	    api.getUsersMovies().then(ui.getAllMoviesSuccess).then(function () {
	      $('.all-movies-table').on('click', showOneMovie);
	    });
	...
	var assignAllMovies = function assignAllMovies(data) {
	  allMovies = data;
	};
	...
	var onSearchByTitle = function onSearchByTitle(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  var filterMoviesResults = [];
	  var searchCriteria = data.movie.name;
	  api.getUsersMovies().then(assignAllMovies).then(function () {
	...
	var onSearchOMDb = function onSearchOMDb(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  var searchCriteria = data.movie.name;
	  var searchCriteriaForAPI = searchCriteria.split(' ').join('+');
	  api.searchOMDb(searchCriteriaForAPI).then(ui.searchOMDbSuccess).then(function () {
	    $('.search-OMDB-movies-table').on('click', onShowOMDbMovie);
	  });
	};

	var onShowOMDbMovie = function onShowOMDbMovie(event) {
	  event.preventDefault();
	  var movieID = $(event.target).attr('data-id');
	  api.showOMDbMovie(movieID).then(ui.showOMDbMovieSuccess).then(function () {
	    $('.OMDB-movie-detail-table').on('click', onAddOMDbMovie);
	  });
	};

	var AddOMDbMovieSuccess = function AddOMDbMovieSuccess(data) {
	  var movie = { movie: {
	      last_viewing: '',
	  ...
	  api.addNewMovieFromOMDb(movie).then(ui.addNewMovieFromOMDbSuccess).then(function () {
	    api.getUsersMovies().then(ui.getAllMoviesSuccess).then(function () {
	      $('.all-movies-table').on('click', showOneMovie);
	    });
	...
	var onAddOMDbMovie = function onAddOMDbMovie(event) {
	  event.preventDefault();
	  var movieID = $(event.target).attr('data-id');
	  // const movieToAdd = api.showOMDbMovie(movieID)
	  api.showOMDbMovie(movieID).then(AddOMDbMovieSuccess);
	};

	var showOnAddNewMovie = function showOnAddNewMovie(event) {
	  event.preventDefault();
	...
	var hideOnAddNewMovie = function hideOnAddNewMovie(event) {
	  event.preventDefault();
	  $('.new-movie-entry-instructions').hide();
	  $('#new-movie').trigger('reset');
	};

	var onCancelOMDbSearch = function onCancelOMDbSearch(event) {
	  event.preventDefault();
	  $('#search-OMDB').trigger('reset');
	  $('.omdb-search-results').hide();
	  $('.omdb-search-results-details').hide();
	...
	var onBackToOMDbSearch = function onBackToOMDbSearch(event) {
	  event.preventDefault();
	  $('.omdb-search-results').show();
	  $('.omdb-search-results-details').hide();
	};

	var clearNewMovieFields = function clearNewMovieFields() {
	  $('#new-movie').trigger('reset');
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var addNewMovie = function addNewMovie(data) {
	  return $.ajax({
	...
	var addNewMovieFromOMDb = function addNewMovieFromOMDb(movie) {
	  return $.ajax({
	    url: config.apiOrigin + '/movies',
	    method: 'POST',
	    headers: {
	...
	var getUsersMovies = function getUsersMovies(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/movies',
	    method: 'GET',
	    headers: {
	...
	var getSelectedMovie = function getSelectedMovie(movieID) {
	  return $.ajax({
	...
	var searchOMDb = function searchOMDb(data) {
	  return $.ajax({
	...
	var showOMDbMovie = function showOMDbMovie(data) {
	  return $.ajax({
	...
	module.exports = {
	  ...
	  showOMDbMovie: showOMDbMovie,
	  addNewMovieFromOMDb: addNewMovieFromOMDb
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(11);
	var showMoviesTemplate = __webpack_require__(13);
	var showMovieTemplate = __webpack_require__(33);
	var showOMDbSearchTemplate = __webpack_require__(34);
	var showOMDbSingleMovie = __webpack_require__(35);
	...
	var addNewMovieSuccess = function addNewMovieSuccess(data) {
	  $('#createMovieSuccess').modal('show');
	  $('#new-movie').trigger('reset');
	  $('.new-movie-entry-instructions').hide();
	};

	var onUpdateMovieSuccess = function onUpdateMovieSuccess(data) {
	  $('#update-movieSuccess').modal('show');
	  $('#update-movie').trigger('reset');
	  $('#search-by-title').trigger('reset');
	};

	var onUpdateMovieFailure = function onUpdateMovieFailure(data) {
	  $('#update-movieFailure').modal('show');
	};

	var addNewMovieFailure = function addNewMovieFailure(data) {
	...
	var getAllMoviesSuccess = function getAllMoviesSuccess(data) {
	  var sortedMovies = data.movies.sort(dynamicSort('name'));
	  var showMoviesHTML = showMoviesTemplate({ movies: sortedMovies });
	...
	var getSearchedMoviesSuccess = function getSearchedMoviesSuccess(data) {
	  var sortedMovies = data.sort(dynamicSort('name'));
	  var showMoviesHTML = showMoviesTemplate({ movies: sortedMovies });
	  $('.movie-display-area').html(showMoviesHTML);
	  // $('#search-by-title').trigger('reset')
	  $('#update-movie').hide();
	...
	var getSelectedMovieSuccess = function getSelectedMovieSuccess(data) {
	  var showMovieHTML = showMovieTemplate({ movies: data });
	...
	var searchOMDbSuccess = function searchOMDbSuccess(data) {
	  if (data.Error === 'Movie not found!') {
	    $('#omdb-search-no-results').modal('show');
	    $('.search-OMDB-movies-table').html('');
	  } else {
	    var sortedMovies = data.Search.sort(dynamicSort('Title'));
	    var showMovieHTML = showOMDbSearchTemplate({ movies: sortedMovies });
	    $('.movie-display-area').html(showMovieHTML);
	    $('.omdb-search-results').show();
	    $('.omdb-search-results-details').hide();
	    $('.your-movies').hide();
	...
	var showOMDbMovieSuccess = function showOMDbMovieSuccess(movie) {
	  var singleMovieArray = [];
	  singleMovieArray.push(movie);
	  var showMovieHTML = showOMDbSingleMovie({ movies: singleMovieArray });
	  $('.movie-display-area').html(showMovieHTML);
	...
	var addNewMovieFromOMDbSuccess = function addNewMovieFromOMDbSuccess(data) {
	  $('#add-OMDB-success').modal('show');
	  // $('.omdb-search-results-details').hide()
	  $('#search-OMDB').trigger('reset');
	};

	var addNewMovieFromOMDbFailure = function addNewMovieFromOMDbFailure(error) {
	  console.error(error);
	...
	module.exports = {
	  ...
	  getSelectedMovieSuccess: getSelectedMovieSuccess,
	  addNewMovieSuccess: addNewMovieSuccess,
	  addNewMovieFailure: addNewMovieFailure,
	  onUpdateMovieSuccess: onUpdateMovieSuccess,
	  onUpdateMovieFailure: onUpdateMovieFailure,
	  getSearchedMoviesSuccess: getSearchedMoviesSuccess,
	  searchOMDbSuccess: searchOMDbSuccess,
	  showOMDbMovieSuccess: showOMDbMovieSuccess,
	  deleteMovieSuccess: deleteMovieSuccess,
	  deleteMovieFailure: deleteMovieFailure,
	  addNewMovieFromOMDbSuccess: addNewMovieFromOMDbSuccess,
	  addNewMovieFromOMDbFailure: addNewMovieFromOMDbFailure,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n    <tr data-id=\""
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.year_released : stack1), depth0))
	    + "</td>\n      <td data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.mpaa_rating : stack1), depth0))
	    + "</td>\n      <td data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.imdbRating : stack1), depth0))
	    + "</td>\n      <td data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.user_rating : stack1), depth0))
	    + "</td>\n      <td data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.ownership_type : stack1), depth0))
	    + "</td>\n      <td data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.last_viewing : stack1), depth0))
	    + "</td>\n      <td data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.times_watched : stack1), depth0))
	    + "</td>\n      <td data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.length : stack1), depth0))
	    + "</td>\n        <!-- <li><button class=\"remove-book\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Remove</button></li> -->\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<h2>Your Movies</h2>\n<h3 class=\"your-movies-subheading\">Click on a movie to edit it</h3>\n<table class=\"table table-hover\">\n  <thead>\n    <tr>\n      <th>Title</th>\n      <th>Year Released</th>\n      <th>Director</th>\n      <th>MPAA Rating</th>\n      <th>IMDB Rating</th>\n      <th>Personal Rating</th>\n      <th>Method of ownership</th>\n      <th>Last time viewed</th>\n      <th>Number of times watched</th>\n      <th>Length (min)</th>\n    </tr>\n  </thead>\n  <tbody class=\"all-movies-table\">\n\n"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<h2>Details on Selected Movie</h2>\n<!-- <h3 class=\"your-movies-subheading\">Click on a movie to edit it</h3> -->\n<table class=\"table table-hover\">\n  <thead>\n    <tr>\n      <th>Title</th>\n      <th>Year Released</th>\n      <th>Director</th>\n      <th>MPAA Rating</th>\n      <th>IMDB Rating</th>\n      <th>Personal Rating</th>\n      <th>Method of ownership</th>\n      <th>Last time viewed</th>\n      <th>Number of times watched</th>\n      <th>Length (min)</th>\n    </tr>\n  </thead>\n  <tbody class=\"all-movies-table\">\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.movies : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n  </tbody>\n</table>\n\n<form id=\"update-movie\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n  <fieldset>\n    <p class=\"delete-update-instructions\">Use the form below to update information about the movie or delete\n    it from your database</p>\n    <input type=\"text\" name=\"movie[name]\" placeholder=\"Title\">\n    <input type=\"text\" name=\"movie[year_released]\" placeholder=\"Year Released\">\n    <input type=\"text\" name=\"movie[director]\" placeholder=\"Director\">\n    <input type=\"text\" name=\"movie[mpaa_rating]\" placeholder=\"MPAA Rating\">\n    <input type=\"text\" name=\"movie[imdbRating]\" placeholder=\"IMDB Rating\">\n    <input type=\"text\" name=\"movie[user_rating]\" placeholder=\"Personal Rating\">\n    <input type=\"text\" name=\"movie[ownership_type]\" placeholder=\"Method of ownership\">\n    <input type=\"text\" onfocus=\"(this.type='date')\" onblur=\"(this.type='text')\"  name=\"movie[last_viewing]\" placeholder=\"Last time viewed\">\n    <input type=\"text\" name=\"movie[times_watched]\" placeholder=\"Times watched\">\n    <input type=\"text\" name=\"movie[length]\" placeholder=\"Length (min)\"><br>\n    <input type=\"submit\" name=\"submit\" value=\"Update Movie Information\" class=\"btn btn-default movie-update-delete-buttons\">\n  </fieldset>\n</form>\n<form id=\"delete-movie\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n  <fieldset>\n    <input type=\"submit\" name=\"submit\" value=\"Delete this movie\" class=\"btn btn-default movie-update-delete-buttons\">\n  </fieldset>\n</form>\n";
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n    <tr data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.imdbID : stack1), depth0))
	    + "\">\n      <td data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.imdbID : stack1), depth0))
	    + "\">"
	  ...
	  return "<h2>OMDb Search Results</h2>\n<h3 class=\"your-movies-subheading\">Click on a movie to see more information</h3>\n<table class=\"table table-hover\">\n  <thead>\n    <tr>\n      <th>Title</th>\n      <th>Year Released</th>\n      <th>Poster</th>\n    </tr>\n  </thead>\n  <tbody class=\"search-OMDB-movies-table\">\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.movies : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n  </tbody>\n</table>\n";
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n      <tr data-id=\""
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.imdbID : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.Released : stack1), depth0))
	    + "</td>\n        <td data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.imdbID : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.Rated : stack1), depth0))
	    + "</td>\n        <td data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.imdbID : stack1), depth0))
	    + "\">"
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.imdbID : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.BoxOffice : stack1), depth0))
	    + "</td>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<h2>Search Details on Selected Movie</h2>\n<h3>Click on the movie below to add it to your database</h3>\n<table class=\"table table-hover\">\n  <thead>\n    <tr>\n      <th>Title</th>\n      <th>Date Released</th>\n      <th>MPAA Rating</th>\n      <th>Length (min)</th>\n      <th>Director</th>\n      <th>Plot</th>\n      <th>IMDB Rating</th>\n      <th>Box Office</th>\n    </tr>\n  </thead>\n  <tbody class=\"OMDB-movie-detail-table\">\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.movies : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "  </tbody>\n</table>\n";
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "362bd8565fb9d38e5640c6921764eab7.jpg";
